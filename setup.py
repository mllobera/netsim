...
setup(
    ...
    description='Network Simulation',  # Optional
    ...
    # project.
    author='MLlobera',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='mllobera@uw.edu',  # Optional
    ...
    install_requires=['python>= 3.7.3', 'numpy>= 1.16.3', 'cython>=0.29.7', 'networkx>=2.3'],  # Optional
    ...
    #   'Source': 'https://github.com/pypa/sampleproject/',
        'Research Lab' : 'https://www.digarlab.uw.edu/',
    },
)